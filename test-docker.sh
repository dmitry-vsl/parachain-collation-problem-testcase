...
POLKADOT=/builds/polkadot/target/release/polkadot
COLLATOR=/builds/substrate-parachain-template/target/release/parachain-collator
...
sleep 500 && echo Sleep finished && exit 1
